...
public class BlobStoreServiceImpl implements BlobStoreService {
	...
	//	log.info("templateId---"+templateId);
		...
		//stream = new FileInputStream("C:/Users/711048/Documents/Userdata/project/blobstore/FSG ISSUED.csv");//getFile(filePath,fileName);//Extract Excel Data as String into list
	...
	public InputStream getFile(String directory, String filename) throws Exception
	{
		...
		{
			log.error("BlobStoreServiceImpl-->getFile : "+filename + "Exception : " + ase.getMessage());
			//ase.printStackTrace();
		}
		catch (AmazonClientException ace)
		{
			log.error("BlobStoreServiceImpl-->getFile : "+filename + "Exception : " + ace.getMessage());
			ace.printStackTrace();
		}
		catch (Exception e)
		{
			log.error("BlobStoreServiceImpl-->getFile : "+filename + "Exception : " + e.getMessage());
			e.printStackTrace();
		}
